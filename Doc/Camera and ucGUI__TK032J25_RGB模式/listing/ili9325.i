...
#line 19 "..\\code\\TFT\\TFT_ILI9328\\ILI9325.c"
...
void LCD_WriteByteSPI(unsigned char byte)
{
   ...
   for(n=0; n<8; n++)			
   {  
	  if(byte&0x80) if (1) ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BSRR = ((uint16_t)0x8000); else ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BRR = ((uint16_t)0x8000);
      	else if (0) ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BSRR = ((uint16_t)0x8000); else ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BRR = ((uint16_t)0x8000);
      byte<<= 1;
		 
	  if (0) ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BSRR = ((uint16_t)0x2000); else ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BRR = ((uint16_t)0x2000);;
    if (1) ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BSRR = ((uint16_t)0x2000); else ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BRR = ((uint16_t)0x2000);;
   }
}
void SPI_WriteComm(u16 CMD)
{			
	if (0) ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->BSRR = ((uint16_t)0x0020); else ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->BRR = ((uint16_t)0x0020);;
	if (0) ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BSRR = ((uint16_t)0x8000); else ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BRR = ((uint16_t)0x8000);;
	if (0) ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BSRR = ((uint16_t)0x2000); else ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BRR = ((uint16_t)0x2000);;
	if (1) ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BSRR = ((uint16_t)0x2000); else ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BRR = ((uint16_t)0x2000);;

	LCD_WriteByteSPI(CMD);
	
	if (1) ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->BSRR = ((uint16_t)0x0020); else ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->BRR = ((uint16_t)0x0020);;
}
void SPI_WriteData(u16 tem_data)
{			
	if (0) ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->BSRR = ((uint16_t)0x0020); else ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->BRR = ((uint16_t)0x0020);;
	if (1) ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BSRR = ((uint16_t)0x8000); else ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BRR = ((uint16_t)0x8000);;
	if (0) ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BSRR = ((uint16_t)0x2000); else ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BRR = ((uint16_t)0x2000);;
	if (1) ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BSRR = ((uint16_t)0x2000); else ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00))->BRR = ((uint16_t)0x2000);;
...
SPI_WriteData(0x40); 
	...
	WriteData(0x0024);	
	WriteData(0x0000);
	WriteData((319>>8)&0X00FF);  
	WriteData(319&0X00FF);
    WriteData((479>>8)&0X00FF);  
	WriteData(479&0X00FF);
    WriteData(0x0000);
	LCD_delay(5);

	WriteComm(0x00B4);	
	WriteData((340>>8)&0X00FF);  
	WriteData(340&0X00FF);
	WriteData((4>>8)&0X00FF);  
	WriteData(4&0X00FF);
	WriteData(1);			   
	WriteData((1>>8)&0X00FF);  
	WriteData(1&0X00FF);
	WriteData(0x0000);

	WriteComm(0x00B6);	
	WriteData((510>>8)&0X00FF);   
	WriteData(510&0X00FF);
	WriteData((4>>8)&0X00FF);  
	WriteData(4&0X00FF);
	WriteData(1);			   
	WriteData((1>>8)&0X00FF);  
  ...
  WriteData(0x0005); 
	...
	Lcd_ColorBox(0,0,320,480,0xFFE0);
...
u16 GetPoint(u16 x,u16 y)
{
	...
	a = *(volatile u16 *) (((u32)0x60020000));x=1;while(--x);

	a = *(volatile u16 *) (((u32)0x60020000));x=1;while(--x);

	b = *(volatile u16 *) (((u32)0x60020000));x=1;while(--x);
