...
{	  	 
	...
	if(EXTI_GetITStatus(((uint32_t)0x00004)) != RESET) 
		...
		if(BIT_Count>1&&BIT_Count<10)
			{	  
			tempdata>>=1;
			if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),((uint16_t)0x0002)))
				{
				tempdata|=0x80;
				parity++;
				}   
			...
			{
			if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),((uint16_t)0x0002)))parity|=0x80;
			}	   
		if(BIT_Count==11)
			{
...
void PS2_En_Data_Report(void)
{
	...
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRL&=0XFFFFFF0F;((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRL|=0X00000080;}; 
...
void PS2_Set_Int(u8 en)
{
	...
	if(en)((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->IMR|=1<<2;
    else ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->IMR&=~(1<<2);
}
...
u8 Wait_PS2_Scl(u8 sta)
{
	u16 t=0;
	sta=!sta;
	while(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),((uint16_t)0x0004))==sta)
	{
		Delay(1);
		t++;
		if(t>2600)return 1;
...
u8 PS2_Get_Byte(void)
{
	...
	while(1)
	{
		...
		if(PS2_Status&0x80)
		{
			...
			PS2_Status&=0x70;
			break;	
		}else if(t>850||PS2_Status&0x40)break;
	}
	PS2_En_Data_Report();
	return temp;    
}	    
...
u8 PS2_Send_Cmd(u8 cmd)
{
	...
	PS2_Set_Int(0);   
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRL&=0XFFFFF0FF;((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRL|=0X00000300;};
	{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRL&=0XFFFFFF0F;((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRL|=0X00000030;};
	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0004));
	Delay(15);
	...
	if(Wait_PS2_Scl(0)==0)
	   {									  
			...
			if(cmd&0x01)
			  {
			   GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0002));
			   high++;
			  }else GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0002));   
			cmd>>=1;
			
			Wait_PS2_Scl(1);
			Wait_PS2_Scl(0);
		   }
		if((high%2)==0)GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0002));
		   else GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0002));
		Wait_PS2_Scl(1); 
		Wait_PS2_Scl(0); 
		GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)), ((uint16_t)0x0002));   
		...
		{((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRL&=0XFFFFFF0F;((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRL|=0X00000080;};
		Wait_PS2_Scl(0);
		if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),((uint16_t)0x0002))==0) Wait_PS2_Scl(1);
		   else 
		      {
			  PS2_En_Data_Report();
			  return 1;
...
void PS2_Init(void)
{
	...
	GPIO_EXTILineConfig(((uint8_t)0x02), ((uint8_t)0x02));  	
